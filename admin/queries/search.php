...
if($stud->num_rows>0){
            ...
            while($row = $stud->fetch_array()){ 
                ...
                <tr style='text-align: center'>
                    ...
                    <td style='border: 1px solid gray'><a href='../PDFCopies/".$row['application_no'].".pdf' target='_blank' style='text-decoration: none;'><button class='btn btn-primary mb-1' data-bs-toggle='tooltip' data-bs-placement='bottom' data-bs-original-title='View form'><i class='bx bxs-show mt-1 p-0' style='font-size: 20px'></i></button></a>
