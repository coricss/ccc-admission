...
$sql = $con->query("UPDATE `student_info` SET `verification` = 'Verified' WHERE `student_id` = $id");
if($sql)
{
...
$sql2=$con->query("INSERT INTO `admin_logs`(`adminID`, `activity`, `date`, `time`) VALUES ($id,'You Verified a Student','$phdate', '$phtime')");

$sqlNotif=$con->query("INSERT INTO `notifications`(`adminID`, `admin_name`, `activity`, `date_time`) VALUES ('$id','$name','verified the application of $stud_name','$date')");
								...
								<table>
									<tbody>
										<tr>
											...
											<br><br><br>
												<h3>Congratualations $fname!</h3>
												
												<p style='text-align:justify;'>
											You've made it to City College of Calamba. Please kindly wait for the announcement and schedule of Entrance Examination on Facebook Page of <a href='https://www.facebook.com/CCCGTCDC' style='color: blue' target='_blank'>CCC Guidance, Counseling, Testing and Career Dev't Office</a></p>
											</td>
										</tr>
									</tbody>
								</table>
