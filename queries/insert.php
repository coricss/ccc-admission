...
if(isset($_POST['btn-submit'])){
    ...
    // $g11card=$application.'_'.$lname.'_'.$_FILES["g11card"]['name'];
    // $g12card=$application.'_'.$lname.'_'.$_FILES["g12card"]['name'];
    // $torpg1=$application.'_'.$lname.'_'.$_FILES["torpg1"]['name'];
    // $torpg2=$application.'_'.$lname.'_'.$_FILES["torpg2"]['name'];

    // $goodmoral=$application.'_'.$lname.'_'.$_FILES["goodmoral"]['name'];
    // $birthcert=$application.'_'.$lname.'_'.$_FILES["birthcert"]['name'];
    // $indigency=$application.'_'.$lname.'_'.$_FILES["indigency"]['name'];
    // $votecert=$application.'_'.$lname.'_'.$_FILES["votercert"]['name'];
    
    // $g11card=$application.'.pdf';
    // $g12card=$application.'.pdf';
    // $torpg1=$application.'.pdf';
    // $torpg2=$application.'.pdf';

    // $goodmoral=$application.'.pdf';
    // $birthcert=$application.'.pdf';
    // $indigency=$application.'.pdf';
    // $votecert=$application.'.pdf';
    ...
    // $birthcert=$_POST['birthtorpg2
    // $indigency=$_POST['indigency'];
    // $votecert=$_POST['votecert'];
   ...
   if($email==isset($row['stud_email'])){
    ...
    if($_FILES['profileImage']['name']!=''){
            ...
            if (empty($error)) {
               if(!in_array($file_ext, $allowed_ext)){
                ...
                $(function() {
                    $.notify({
                        title: 'Invalid Photo',
                        message: 'Uploaded file is not a valid image file type. Only JPG and PNG are allowed!'
                    },{
                    animate: {
                        enter: 'animate__animated animate__fadeInDown',
                        exit: 'animate__animated animate__fadeOutRight'
                ...
                $(function() {
                    $.notify({
                        ...
                        message: 'Please upload different photo!'
                    },{
                    animate: {
                        enter: 'animate__animated animate__fadeInDown',
                        exit: 'animate__animated animate__fadeOutRight'
                ...
                //KAPAG RESIDENTE NG CALAMBA
           
                //KAPAG FRESHMAN at RESIDENTE NG CALAMBA
                //EDIT MOTO
                if($admit=="Freshman"){
                    if(($g11!='')||($g12!='')||($gmoral!='')||($bcert!='')||($cor!='')||($voter!='')){
                        if(($_FILES["g11card"]['size'] > 5000000 )||( $_FILES["g12card"]['size'] > 5000000 )||( $_FILES["goodmoral"]['size'] > 5000000)||( $_FILES["birthcert"]['size'] > 5000000)||( $_FILES["indigency"]['size'] > 5000000)||( $_FILES["votercert"]['size'] > 5000000)){
                            $_SESSION['message'] = "<script>
                            $(function() {
                               $.notify({
                                   title: 'File too Large!',
                                   message: 'File should not be greater than 500KB'
                               },{
                               animate: {
                                   enter: 'animate__animated animate__fadeInDown',
                                   exit: 'animate__animated animate__fadeOutRight'
                        ...
                        if (empty($error)) {
                            if((!in_array($g11_ext, $ext)) && (!in_array($g12_ext, $ext))&& (!in_array($gmoral_ext, $ext))&& (!in_array($bcert_ext, $ext))&& (!in_array($cor_ext, $ext))&& (!in_array($voter_ext, $ext))){
                                $_SESSION['message'] = "<script>
                            $(function() {
                               $.notify({
                                   title: 'Invalid File Type',
                                   message: 'Please upload file in .PDF .DOCX .JPG and .PNG format'
                               },{
                               animate: {
                                   enter: 'animate__animated animate__fadeInDown',
                                   exit: 'animate__animated animate__fadeOutRight'
                ...
                $(function() {
                    $.notify({
                        title: 'Pre-registration Done! Check your email for more information',
                        message: 'Kindly download/print a copy of your pre-registration form <a href=PDFCopies/$filename>here</a> or <b>check your email</b>',
                        url: 'PDFCopies/$pdfname'
                    },{
                    animate: {
                        enter: 'animate__animated animate__fadeInDown',
                        exit: 'animate__animated animate__fadeOutRight'
                ...
                window.history.replaceState( null, null, window.location.href );
                    ...
                    $_SESSION['message'] = "<script>
                        $(function() {
                           $.notify({
                               title: 'PLEASE UPLOAD REQUIREMENTS',
                               message: 'Please upload file in .pdf, .docx, .jpg and .png format'
                           },{
                           animate: {
                               enter: 'animate__animated animate__fadeInDown',
                ...
                //KAPAG TRANFER at residente ng calamba
                 //EDIT MOTO
                else{
                    if(($tor1!='')||($tor2!='')||($gmoral!='')||($bcert!='')||($cor!='')||($voter!='')){
                        if($_FILES["torpg1"]['size'] > 500000 || $_FILES["torpg2"]['size'] > 500000 || $_FILES["goodmoral"]['size'] > 500000|| $_FILES["birthcert"]['size'] > 500000|| $_FILES["indigency"]['size'] > 500000|| $_FILES["votercert"]['size'] > 500000){
                            $_SESSION['message'] = "<script>
                            $(function() {
                               $.notify({
                                   title: 'File too Large!',
                        ...
                        if (empty($error)) {
                            if(!in_array($tor1_ext, $ext) && !in_array($tor1_ext, $ext)&& !in_array($gmoral_ext, $ext)&& !in_array($bcert_ext, $ext)&& !in_array($cor_ext, $ext)){
                                $_SESSION['message'] = "<script>
                            $(function() {
                               $.notify({
                                   title: 'Invalid File Type',
            ...
            //KAPAG HINDI RESIDENTE NG CALAMBA
        ...
        // if($calambares=="Yes"){
            ...
            if($admit=="Freshman"){
                if(($g11!='')||($g12!='')||($gmoral!='')||($bcert!='')||($cor!='')||($voter!='')){
                    if(($_FILES["g11card"]['size'] > 500000 )||( $_FILES["g12card"]['size'] > 500000 )||( $_FILES["goodmoral"]['size'] > 500000)||( $_FILES["birthcert"]['size'] > 500000)||( $_FILES["indigency"]['size'] > 500000)||( $_FILES["votercert"]['size'] > 500000)){
                        $_SESSION['message'] = "<script>
                        $(function() {
                           $.notify({
                               title: 'File too Large!',
            ...
            //KAPAG TRANFER at residente ng calamba
             //EDIT MOTO
                ...
                if(($tor1!='')||($tor2!='')||($gmoral!='')||($bcert!='')||($cor!='')||($voter!='')){
                    ...
                    if (empty($error)) {
                        if(!in_array($tor1_ext, $ext) && !in_array($tor1_ext, $ext)&& !in_array($gmoral_ext, $ext)&& !in_array($bcert_ext, $ext)&& !in_array($cor_ext, $ext)&& !in_array($voter_ext, $ext)){
                            $_SESSION['message'] = "<script>
                        $(function() {
                           $.notify({
                               title: 'Invalid File Type',
        ...
        $_SESSION['message'] = "<script>
                $(function() {
                    $.notify({
                        title: 'Invalid Photo',
                        message: 'Please upload 2x2 photo!'
                    },{
                    animate: {
                        enter: 'animate__animated animate__fadeInDown',
                        exit: 'animate__animated animate__fadeOutRight'
