...
try {
    ...
    $mail->Subject =  "City College of Calamba Online Admission";
    $mail->Body    =  
    "
...
<body>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <br><br><br>
                                            <h5>Application number: $application</h5><br><br>
                                                <h3>Hello $fname,</h3>
                                                
                                                <p style='text-align:justify;'>
                                                Thank you for completing the online pre-registration. Your details has been sent to City College of Calamba.</p>
                                                <br>
                                                <p style='text-align:justify;'>To confirm your admission, kindly print your copy of registration form along with the requirements and bring on the scheduled appointment to be announce on Facebook page of <a href='https://www.facebook.com/CCCGTCDC' style='color: blue' target='_blank'>CCC Guidance, Counseling, Testing and Career Dev't Office</a>.
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    $(function() {
        $.notify({
            ...
            message: 'Please download a copy of your pre-registration form <a href=PDFCopies/$filename>here</a> form for your copy. or check your email',
